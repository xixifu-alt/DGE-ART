...
//       domains.add(bd15);
        ...
        for (int[][] bd : domains) {
            ...
            for (int n : num) {
                ...
                String s1 = "E:/TestEfficiency/" + bd.length + "d-FscsART-" + n + ".txt";
                String s2 = "E:/TestEfficiency/" + bd.length + "d-LimBalKDFC-" + n + ".txt";
                String s3 = "E:/TestEfficiency/" + bd.length + "d-HnswART2-" + n + ".txt";
    ...
    public static void testLimBalKDFC(String file, int[][] bd, int pointNum) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            kdfc.testLimBalKDFC_Efficiency(pointNum, backNum,bd);
            long n2 = System.nanoTime();
            if (i != 0 && i != 1 && i != 2) {
                sum = sum + n2 - n1;
                out.println(1.0 * (n2 - n1) / 1e6);
